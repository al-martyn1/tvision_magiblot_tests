...
elseif(WIN32)
    message(NOTICE "STM32 NOT defined or false, and WIN32 defined - using WIN32 target")
    set(TARGET_WIN32 1)
...
elseif(CMAKE_SYSTEM_NAME STREQUAL "Linux")
    message(NOTICE "STM32 nor WIN32 defined - using Linux target")
elseif(CMAKE_SYSTEM_NAME STREQUAL "Darwin")
    message(NOTICE "STM32 nor WIN32 nor Linux defined - using Darwin target")
elseif(CMAKE_SYSTEM_NAME STREQUAL "Android")
    message(NOTICE "STM32 nor WIN32 nor Linux nor Darwin defined - using Android target")
else()
...
function(fw_add_target_options TARGET)
    ...
    if(STM32)
        ...
        message(NOTICE "Configuring executable for WIN32/Linux/other full size platform")
    endif()
    ...
    foreach(index RANGE 1 ${maxArgN} 1)
        ...
        elseif(${ARGV${index}} STREQUAL "BIGOBJ")
            if(STM32)
                ...
                message(NOTICE "Setting BIGOBJ (-Wa,-mbig-obj) option for '${TARGET}' application")
                if(WIN32 OR STM32)
